...
\frontmatter
\pagestyle{bare}
\ \vspace{0.4\textheight-0.2\paperwidth}
\begin{center}
  \includegraphics[width=0.4\paperwidth]{fig/Logo 3.png}
\end{center}
\clearpage
\ 
\clearpage
...
\begin{footnotesize}
  ...
  \end{multicols}
  \vspace{-4ex}
  \begin{multicols}{3}[\noindent Особые благодарности:\vspace{-3ex}]
    \noindent\em
    Александр Савин\newline
    Александр Миненков\newline
    Андрей Вржещ\newline
  ...
  \noindent советскаятипография.рус {\tiny\ding{108}} universo.pro

  \vfil

  \noindent\textbf{Пилотный экземпляр.}
  \hfill{git: rev.\gitAbbrevHash\gitDirty\ tags: \gitTags}
\end{footnotesize}
...
\newgeometry{left=15mm,right=15mm,top=28.2mm,bottom=5mm}
\thispagestyle{plainfullpagecover}
\begin{center}
\includegraphics[width=11.4cm]{hegel-img001.jpg}
\end{center}
